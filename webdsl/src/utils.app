...
// global constants would be nice
// it also isn't that nice to hardcode every page fragment that needs to be refreshed across
// fragment borders, but I couldn't find a way that is better in every regard...
entity Globals {
  navbarId: String (default = "__navbar")
  navbarTitleId: String (default = "__title")
	navbarLogoId: String (default = "__nlogo")
  rootId: String (default = "__root")
	notificationsId: String (default = "__notifications")
	footerLogoId: String (default = "__flogo")
}
var G := Globals{}
